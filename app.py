...
def build_coordinator():
    ...
    prompt = (
        ...
        "- 'convert to pdf' + CSV file -> Use convert_csv_to_pdf (NOT convert_pdf_to_word!)\n"
        "- 'convert to pdf' + Word file -> Use convert_word_to_pdf\n"
        "- 'convert to pdf' + Excel file -> Use convert_excel_to_pdf\n"
        "- 'convert to pdf' + PowerPoint file -> Use convert_powerpoint_to_pdf\n"
        "- 'convert to word/docx' + PDF file -> Use convert_pdf_to_word\n"
        "- 'convert to excel/xlsx' + PDF file -> Use convert_pdf_to_excel\n"
