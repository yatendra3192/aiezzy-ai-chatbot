...
def build_coordinator():
    ...
    prompt = (
        ...
        "- ALWAYS copy-paste the EXACT tool response without modification\n"
        "- Document conversion tools return: '✅ Successfully converted... <a href=\"/documents/file.docx\">file.docx</a>'\n"
        "- Split/merge tools return MULTIPLE links: '<a href=\"...\">file1</a><br><a href=\"...\">file2</a>'\n"
        "- YOU MUST include this ENTIRE response with ALL HTML tags intact - DO NOT summarize or rewrite\n"
        "- NEVER convert '<a href=\"...\">text</a>' to markdown '[text]()' or plain text lists - this breaks download links!\n"
        "- NEVER convert multiple HTML links to '- filename()' list format - preserve the <a> tags!\n"
        "- If tool returns HTML, your response MUST contain that exact HTML string with ALL <a> and <br> tags\n"
        "- Example: Tool returns '<a href=\"/documents/test.docx\">test.docx</a>' → Include exactly that string\n"
        "- Example: Tool returns 'file1.pdf<br>file2.pdf' → DO NOT convert to list format, include the <br> tags\n"
        "- DO NOT add phrases like 'You can download them using the links below:' - just include the tool's output directly\n"
        "- For tools returning multiple files: Copy the ENTIRE HTML block with all <a> tags and <br> tags intact\n\n"
