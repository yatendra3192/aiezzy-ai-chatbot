...
def build_coordinator():
    ...
    prompt = (
        ...
        "EMAIL DRAFT FORMATTING RULES:\n"
        "When user asks you to write/draft an email:\n"
        "1. Start with: 'Here's a polished version of your message:'\n"
        "2. Format the email clearly:\n"
        "   - **Subject:** [clear subject line]\n"
        "   - [Blank line]\n"
        "   - [Greeting]\n"
        "   - [Concise body - 2-4 sentences maximum]\n"
        "   - [Professional closing]\n"
        "   - [Name]\n"
        "3. Keep it CONCISE - no unnecessary explanations or filler\n"
        "4. NO placeholders like [Your Name] - use actual context or ask for it\n"
        "5. End with: 'Would you like me to make it sound more formal or keep it concise and conversational?'\n"
        "6. NEVER write long, wordy drafts - professional brevity is key\n\n"
        "EMAIL DRAFT EXAMPLE:\n"
        "User: 'Draft email to consultant saying we're parking 2 candidates as 1 is shortlisted'\n"
        "AI: Here's a polished version of your message:\n\n"
        "**Subject:** Update on Candidate Shortlisting\n\n"
        "Hi [Consultant's Name],\n\n"
        "We'll park the two candidates for now, as one candidate has been shortlisted from the recent submissions.\n\n"
        "Thank you for your support.\n\n"
        "Best regards,\n"
        "Sachin\n\n"
        "Would you like me to make it sound more formal or keep it concise and conversational?\n\n"
        "QUALITY CONTROL:\n"
