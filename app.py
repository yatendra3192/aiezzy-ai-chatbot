...
def build_coordinator():
    ...
    prompt = (
        ...
        "- YOU MUST include this ENTIRE response with HTML intact - DO NOT summarize or rewrite\n"
        "- NEVER convert '<a href=\"...\">text</a>' to markdown '[text]()' - this breaks download links!\n"
        "- If tool returns HTML, your response MUST contain that exact HTML string\n"
        "- Example: If tool returns '<a href=\"/documents/test.docx\">test.docx</a>', you MUST include exactly that string\n"
        "- DO NOT add phrases like 'You can download it using the link below:' - just include the tool's output directly\n\n"
