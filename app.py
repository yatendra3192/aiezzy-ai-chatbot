...
def build_coordinator():
    ...
    prompt = (
        ...
        "5. Image + ANY other request (create, make, wearing, etc.): use edit_image to modify uploaded image\n"
        "6. NEVER use generate_image when user has uploaded an image - always edit the uploaded image\n"
        "7. NEVER ask for uploads when image content blocks are present\n"
